...
dayrange = datelist("2017-07-03", "2017-07-21")
print (dayrange)
print ("--------------------------------------------")
dayinstock=[]
row=0
...
dates=pd.DataFrame(iovol,index=dayinstock,columns=['in400','out40','in1000','out1000','in2000','out2000','volume','p_change','turnover','close'])
print (dates)
csvname=stock+'.csv'
